...
namespace test.Controllers
{
    ...
    {
        GameStoreEntities1 entity = new GameStoreEntities1();
        ...
        public ActionResult Login(LoginViewModel credentials)
        {
            ...
            bool userExist = entity.Users.Any(x => x.UserName == credentials.UserName && x.UserPassword == credentials.UserPassword);
            User user = entity.Users.FirstOrDefault(x => x.UserName == credentials.UserName && x.UserPassword == credentials.UserPassword);
            ...
            else
            {
                ...
                else 
                {
                    if (logAttemptsValue.ToString() == "3")
                    {
                        ...
                        return RedirectToAction("LoginAttempts", "Home");
                    }
        ...
        public ActionResult ForgotPassword(string EmailID)
        {
            ...
            using (GameStoreEntities1 dc = new GameStoreEntities1())
            {
